  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        ...
        <address>
          <strong>Hebat Hotel</strong>
          <br>Jl. Sumbawa Besar
          <br>
          Santong, Kode Pos 5456
          <br>
        </address>
        <address>
          <div class="hub">
            <h3 class="sosmed">Hubungi Kami</h3><br>
            <a class="sosmed" href="https://web.facebook.com/jusman.indri.180319/" target="_blank"><i class="fab fa-facebook fa-2x" style="color: grey"></i></a>
            <a class="sosmed" href="https://www.instagram.com/juss_tn/" target="_blank"><i class="fab fa-instagram fa-2x" style="margin-left: 7%; color: grey"></i></i></a>
          ...
          <!-- <abbr title="Email">Inbox :</abbr>
            <a href="mailto:#">Hebathotel.htl.com</a> -->
        </address>
      </div>
    </div>
    <br><br>

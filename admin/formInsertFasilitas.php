    ...
    <form action="proses/prosesInsertFasilitas.php" method="POST">
        <div class="container">
            ...
            <div class="custom-control custom-checkbox">
                ...
                <input type="checkbox" name="fasilitas[]" value="Kondom" class="custom-control-input" id="customCheck2">
                <label class="custom-control-label" for="customCheck2">Kondom</label>
            </div>
            <div class="form-group">
                <label>Status</label>
